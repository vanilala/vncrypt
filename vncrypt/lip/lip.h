...
===============================
  ...
  ----------
        ...
        zstrtozbas, zstrtoz, zdoub, zsbastoz, zbastoz, zstobas, ztobas,
...
\******************************************************************************/
    ...
    long zrandomgprime(long lq, long nbtests, long smallval,
        ...
        * if smallval==0 g will be randomly selected (using zrandomb), otherwise
...
\******************************************************************************/
    ...
    long ztridiv(verylong n, verylong *cof, long b1, long b2);
        ...
        * (unless b1 < 0, b1 > b2, or b2 >= RADIX, in which case it returns 0)
	...
	* returns 0 if no factor found
    ...
    long zfecm(verylong n, verylong *f, long s, long *curvebnd,
              long *phase1bnd, double grow, long nbtests,
	      long ecmonly, long info, FILE *fp);
        /******************************************************************\
        ...
        * by a factor of grow for each new curve) or if n <= 2^(NBITS/2),
	...
	* if ecmonly==0 then it may try trial division or squfof,
	* if ecmonly is not zero, it will only use ecm.
        * 
	...
	* Runs silently if fp is NULL.
    ...
    long zecm(verylong n, verylong *f, long s, long curvebnd,
              long phase1bnd, double grow, long nbtests, long ecmonly, long info);
        /******************************************************************\
